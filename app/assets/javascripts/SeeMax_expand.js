...
//   // content box open/closing
//   //
//   // if no boxes open, click to open it
//   // if one box open, click it to close itself
//   // if one box open, click another box
//   $('.content-box').not('.disabled').click(function() {
//     toggleCard($(this));
//   });
